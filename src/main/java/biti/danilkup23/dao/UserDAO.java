...
public class UserDAO implements DAO<User> {
    ...
    public User get(int id) throws SQLException {
        ...
        try(Connection connection = DatabaseConnector.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SQLQueries.GET_BY_USER_ID.getQuery())) {
    ...
    public List<User> getAll() throws SQLException {
        ...
        try(Connection connection = DatabaseConnector.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SQLQueries.GET_ALL_USERS.getQuery())) {
    ...
    public void add(User user) throws SQLException {
        try(Connection connection = DatabaseConnector.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SQLQueries.ADD_USER.getQuery())) {
    ...
    public void removeById(int id) throws SQLException {
        try(Connection connection = DatabaseConnector.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SQLQueries.REMOVE_BY_USER_ID.getQuery())) {
    ...
    public User getUserByFullName(String firstName, String lastName) throws SQLException {
        ...
        try(Connection connection = DatabaseConnector.getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement(SQLQueries.GET_USER_BY_FULL_NAME.getQuery())) {
